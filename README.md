# 🐮 Vaquita: First gamify DeFi platform
           
Vaquita is designed to build long-term savings habits through gamification and smart incentives, turning savings into an engaging experience where commitment is rewarded and early withdrawals are penalized, ensuring better returns for disciplined savers.
 
-----
 
## 🌎 Problem We're Solvingg

> **60% of people in LATAM don't save.**  
> There’s a lack of culture, tools, and incentives to encourage long-term saving habits.
> Only 0,06% of all the world use DeFi 

Vaquita addresses this by making DeFi fun,, social, and financially rewarding
...
_Vaquita_ is an action where lot of people join to save for a common purpose. In this case, the community join to save and reach their goals together.

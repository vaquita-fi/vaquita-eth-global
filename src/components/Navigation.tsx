...
export function DesktopSidebar() {
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 h-screen w-64 border-r-2 border-[#B97204] z-50 select-none">
...
export function MobileNavigation() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 h-18  flex justify-around items-center z-10  bg-background w-full rounded-t-lg  backdrop-blur-xl shadow-[0_-10px_30px_rgba(15,23,42,0.18)] select-none">
      {navItems.map(({ href, icon, label }) => (
